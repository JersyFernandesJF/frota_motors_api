...
import com.example.kubico.infrastructure.mapper.PaymentMapper;
import com.example.kubico.infrastructure.persistence.PaymentRepository;
...
public class PaymentService {
  ...
  public Payment updateStatus(
    ...
    if (status == PaymentStatus.COMPLETED) {
      saved.getPurchase().setStatus(com.example.kubico.domain.enums.OrderStatus.CONFIRMED);
  ...
  public Payment refundPayment(UUID id, String notes) {
    ...
    // Update purchase status
    saved.getPurchase().setStatus(com.example.kubico.domain.enums.OrderStatus.REFUNDED);
    purchaseRepository.save(saved.getPurchase());
