...
CREATE INDEX IF NOT EXISTS idx_complaints_reported_vehicle ON complaints(reported_vehicle_id);
CREATE INDEX IF NOT EXISTS idx_complaints_reported_part ON complaints(reported_part_id);
CREATE INDEX IF NOT EXISTS idx_complaints_reported_agency ON complaints(reported_agency_id);
