...
CREATE INDEX IF NOT EXISTS idx_reviews_reviewed_vehicle ON reviews(reviewed_vehicle_id);
CREATE INDEX IF NOT EXISTS idx_reviews_reviewed_part ON reviews(reviewed_part_id);
CREATE INDEX IF NOT EXISTS idx_reviews_reviewed_agency ON reviews(reviewed_agency_id);
CREATE INDEX IF NOT EXISTS idx_reviews_reviewed_rental ON reviews(reviewed_rental_id);
