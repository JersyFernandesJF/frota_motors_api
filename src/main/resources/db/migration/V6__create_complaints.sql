CREATE TABLE complaints (
    ...
    CONSTRAINT fk_complaint_reported_property FOREIGN KEY (reported_property_id) REFERENCES properties(id),
...
CREATE INDEX idx_complaints_reported_property ON complaints(reported_property_id);
